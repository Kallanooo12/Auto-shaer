...
###----------[ INI LOGO ]----------###
def logo_menu():
    li = '                               \033[1;94m ASSALAMU ALAYKOM  AND FUK YOU 🥵\n'
...
╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝    
    ...
    ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
    \33[1;32m====================================================
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;92m sk 😎kalyan🥵
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;93m kallan mitro 😈🥵
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;94m sory 🥵
    ...
    \33[1;32m====================================================
    """)
    cetak(nel(f'\n \t {H2}  FB AUTO SHARE TOOLS BRO \n\n \t\t {H2}~[{K2} K{K2}A{K2}L{K2}Y{K2}A{K2}N {H2}]~',
              title=f'{P2}  {H2}[{K2} K{K2}A{K2}L{K2}Y{K2}A{K2}N {K2}🙀{K2}🙀{K2}🙀{K2}🙀{K2}🙀{K2}🙀 {K2}🙀{K2}😍{K2}🙀{K2}🙀{K2}🙀{K2}🙀{K2}🙀 {K2}🙀{K2}😊{K2}🙀{K2}🙀{H2}]',
    ...
    try:
        ...
        cetak(nel(f'{P2} LOGIN KALYAN?', width=24, style=f"#00FF00"));
        time.sleep(2)
        bot_share()
    except:
...
{B2} Current Date    :{H2} {hari}, {tanggal}''', title=f'{P2} {H2}[ {K2}Cookie Id Information {H2}]',
    ...
    link = input(f"{P}   └──> : {H}")
    cetak(nel(f'{H2} K{J2}A{K2}L{B2}Y{N2}A{K2}L{B2}N{H2}M{N2}🙀{P2}🙀', subtitle=f'{P2}┌─', subtitle_align='left',
              width=22, padding=0, style='blue'))
    jumlah = int(input(f"{P}   └──> : {H}"))
    cetak(
        nel(f'{H2} K{H2}A{H2}L{H2}Y{H2}A{H2}N 🙀{B2}F{B2}B {O2}A{O2}U{O2}T{O2}O {N2}S{N2}H{N2}A{N2}R{N2}E {K2}S{K2}T{K2}A{K2}R{K2}T',
    ...
    try:
        ...
        for x in range(jumlah):
            ...
            if "id" in post:
                ...
                print(f'{P}\r   └──>{H} {bas} {K} K{K}A{K}L{K}Y{K}A{K}N 🙀SEND {H}[{n}]{P}{K} AUTO SHARE {H} SUCSSES{H} ',
                      end='');
                sys.stdout.flush()
            else:
                print("\n")
